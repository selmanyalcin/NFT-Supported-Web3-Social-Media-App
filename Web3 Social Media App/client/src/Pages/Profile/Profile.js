...
class Profile extends Component {
  ...
  componentDidMount = async () => {
    ...
    console.log("userıd", this.state.userName);
    const Users = new Moralis.Object.extend("Users");
    const userquery = new Moralis.Query(Users);
    userquery.equalTo("username", this.state.userName);
    const userresults = await userquery.find();
    for (let i = 0; i < userresults.length; i++) {
      console.log("asdf");
      const object = userresults[i];
      const following = object.get("following");
      const followed = object.get("followers");
      console.log("following", following, "followed", followed);
      this.setState({
        following: following,
        followers: followed,
      });
    ...
    console.log("selman", userId);
    const Get2 = Moralis.Object.extend("Posts");
                  ...
                  <div className="ProfileDetails">
                    ...
                    >
                      ...
                      <div class="file-input">
                        <input
                          ...
                          class="file"
                        />
                        <label for="profilePhotoFileUpload">
                          Set a Profile Photo
                        </label>
                      </div>
                      <div class="file-input">
                        <input
                          ...
                          class="file"
                        />
                        <label for="profilePhotoFileUpload2">
                    ...
                    <div className="ProfileText">
                      ...
                      <div className="ButtonsSection">
                        ...
                        <Link className="Link" to="/ProfileMonetized">
                          Monetized
                        </Link>
                      </div>
                    </div>
