...
class Share extends React.Component {
  ...
  componentDidMount = async () => {
    ...
    const Get = Moralis.Object.extend("Monetized");
  ...
  render() {
    const Share2 = async () => {
      ...
      let Tag = "";
      const userId = localStorage.getItem("userId");
      const Post = Moralis.Object.extend("Monetized");
      const Get = Moralis.Object.extend("_User");
      const query = new Moralis.Query(Get);
      query.equalTo("objectId", userId);
      console.log(document.getElementById("PostText2").value);
      const results = await query.find();
      for (let i = 0; i < results.length; i++) {
        const object = results[i];
      ...
      Post1.set("PostText", document.getElementById("PostText2").value);
          ...
          <div className="Post">
            <div className="Post1">
              <img
                ...
                src={this.state.pp}
              />
              <input id="PostText2" placeholder="Share Something..." />
            </div>
            <div className="Post2">
